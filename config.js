...
const CONFIG = {
  ...
  wedding: {
    ...
    tel: "02-539-2956",
    info: "지하철: 2호선 삼성역 8번 출구 (도보 1분 이내)<br>버스: 삼성역 7번 출구에서 하차<br>간선(파랑): 143, 146, 301, 342, 343, 345, 401, 8146<br>지선(초록): 2413, 2415, 3217, 3412, 3414, 3417, 4318<br>주차장<br>주차는 도보 5분 이내 외부 주차장으로, 더베일리하우스 앞에서 안내 받아주세요.<br>안내 사항<br>주변 교통이 혼잡하여 주차 시간이 많이 소요될 수 있어 대중교통 이용을 추천드립니다.",
    mapLinks: {
  ...
  accounts: {
    groom: [
      { role: "신랑", name: "심지훈", bank: "국민은행", number: "000-000-000000" },
      { role: "아버지", name: "심시영", bank: "신한은행", number: "000-000-000000" },
      { role: "어머니", name: "이미령", bank: "우리은행", number: "000-000-000000" }
    ],
    bride: [
