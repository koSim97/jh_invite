...
const CONFIG = {
  ...
  wedding: {
    ...
    tel: "02-539-2956",
    info: "지하철: 2호선 삼성역 8번 출구 (도보 1분 이내)\n버스: 삼성역 7번 출구에서 하차\n간선(파랑): 143, 146, 301, 342, 343, 345, 401, 8146\n지선(초록): 2413, 2415, 3217, 3412, 3414, 3417, 4318\n주차장\n주차는 도보 5분 이내 외부 주차장으로, 더베일리하우스 앞에서 안내 받아주세요.\n안내 사항\n주변 교통이 혼잡하여 주차 시간이 많이 소요될 수 있어 대중교통 이용을 추천드립니다.",
    mapLinks: {
